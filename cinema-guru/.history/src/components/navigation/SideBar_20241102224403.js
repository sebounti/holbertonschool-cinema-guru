...
const SideBar = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://localhost:8000/api/activity", {
        headers: {
  ...
  return (
    <div className="sidebar">
      <ul>
        <li
          className={selected === "home" ? "active-item" : "sidebar-item"}
        ...
        <li
          className={selected === "favorites" ? "active-item" : "sidebar-item"}
        ...
        <li
          className={selected === "watchlater" ? "active-item" : "sidebar-item"}
